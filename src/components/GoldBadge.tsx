...
export default function GoldBadge({ label, icon = 'verified_user' }: GoldBadgeProps) {
  return (
    <div className="bg-gold/10 border border-gold px-3 py-1 rounded-full flex items-center gap-1.5">
